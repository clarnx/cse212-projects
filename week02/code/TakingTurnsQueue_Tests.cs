...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Enqueue added to front instead of back. Also GetNextPerson did not
    // re-enqueue people with infinite turns (turns <= 0).
    ...
    // Defect(s) Found: Same as ForeverZero - Enqueue added to front, and negative turns not handled.
